...
export interface Schema$GoogleCloudPolicytroubleshooterV1BindingExplanation {
     ...
     */
        memberships?: { [key: string]: Schema$GoogleCloudPolicytroubleshooterV1BindingExplanationAnnotatedMembership; }|null;
        /**
...
troubleshoot(paramsOrCallback?: Params$Resource$Iam$Troubleshoot|BodyResponseCallback<Schema$GoogleCloudPolicytroubleshooterV1TroubleshootIamPolicyResponse>, optionsOrCallback?: MethodOptions|BodyResponseCallback<Schema$GoogleCloudPolicytroubleshooterV1TroubleshootIamPolicyResponse>, callback?: BodyResponseCallback<Schema$GoogleCloudPolicytroubleshooterV1TroubleshootIamPolicyResponse>): void|GaxiosPromise<Schema$GoogleCloudPolicytroubleshooterV1TroubleshootIamPolicyResponse> {
  ...
  const parameters = {
    ...
    if (callback) {
    createAPIRequest<Schema$GoogleCloudPolicytroubleshooterV1TroubleshootIamPolicyResponse>(parameters, callback);
  } else {
    return createAPIRequest<Schema$GoogleCloudPolicytroubleshooterV1TroubleshootIamPolicyResponse>(parameters);
  }
}
